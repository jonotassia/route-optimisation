...
class Human:
    ...
    @dob.setter
    def dob(self, value):
        if demog.get_date(value, date_of_birth=1):
            self.dob = value
    ...
    def get_name(self):
        ...
        self.middle_name = middle_name
        self.last_name = last_name
        self.full_name = self.full_name = self.first_name + self.middle_name + self.last_name
...
class Patient(Human):
    ...
    def __init__(self, status=1, first_name="", last_name="", middle_name="", dob="", sex="", address=""):
        """Initiates and writes-to-file a human with the following attributes:
        id, first name, last name, middle name, date of birth, sex, and address.
